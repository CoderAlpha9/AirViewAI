...
class Settings(BaseSettings):
    ...
    openaq_api_key: str | None = Field(
        default=None, validation_alias=AliasChoices("OPENAQ_API_KEY", "AIRVIEW_OPENAQ_API_KEY")
    )
    data_gov_in_api_key: str | None = Field(
        default=None,
        validation_alias=AliasChoices("DATA_GOV_IN_API_KEY", "AIRVIEW_DATA_GOV_IN_API_KEY"),
    )
    nasa_firms_map_key: str | None = Field(
        default=None,
        validation_alias=AliasChoices("NASA_FIRMS_MAP_KEY", "AIRVIEW_NASA_FIRMS_MAP_KEY"),
    )
    copernicus_client_id: str | None = Field(
        default=None,
        validation_alias=AliasChoices("COPERNICUS_CLIENT_ID", "AIRVIEW_COPERNICUS_CLIENT_ID"),
    )
    copernicus_client_secret: str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            "COPERNICUS_CLIENT_SECRET", "AIRVIEW_COPERNICUS_CLIENT_SECRET"
        ),
    )
